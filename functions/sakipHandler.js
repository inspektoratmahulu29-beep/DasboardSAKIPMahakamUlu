...
// OPTIMASI: Ambil semua data OPD, skor, evidence, QA sekaligus (batch)
...
// Get Data untuk satu OPD (fallback jika bulk tidak tersedia)
  ...
  try {
    switch (action) {
      ...
      case 'uploadEvidence': { 
        ...
        if (base64Data.length > 20 * 1024 * 1024) return jsonResponse({ status: 'error', msg: 'File melebihi batas 15MB!' }); 
